...
namespace SalesWebMvcApp.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Departments d2 = new Departments("Eletronics");
            Departments d3 = new Departments("Fashion");
            Departments d4 = new Departments("Books");

            Saller s1 = new Saller("Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21),1000.0, d1);
            Saller s2 = new Saller("Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31),1500.0, d2);
            Saller s3 = new Saller("Alex Gray", "alex@gmail.com", new DateTime(1988, 1, 15),1200.0, d3);
            Saller s4 = new Saller("Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30),2000.0, d1);
            Saller s5 = new Saller("Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9),5000.0, d4);
            Saller s6 = new Saller("Alex Pink", "alex_pink@gmail.com", new DateTime(2002, 4, 5),1000.0, d1);
